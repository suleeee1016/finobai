          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="backdrop-blur-xl bg-white/10 rounded-2xl p-6 border border-white/20">
                ...
                <div className="space-y-4">
                  <button className="w-full p-4 bg-gradient-to-r from-green-500/20 to-emerald-600/20 hover:from-green-500/30 hover:to-emerald-600/30 rounded-xl border border-green-400/30 text-left transition-all">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-white font-medium">Gelir Ekle</p>
                        <p className="text-sm text-slate-400">Yeni gelir kaydı oluştur</p>
                      </div>
                    </div>
                  </button>

                  <button className="w-full p-4 bg-gradient-to-r from-red-500/20 to-pink-600/20 hover:from-red-500/30 hover:to-pink-600/30 rounded-xl border border-red-400/30 text-left transition-all">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-white font-medium">Gider Ekle</p>
                        <p className="text-sm text-slate-400">Yeni gider kaydı oluştur</p>
                      </div>
                    </div>
                  </button>

                  <button className="w-full p-4 bg-gradient-to-r from-blue-500/20 to-indigo-600/20 hover:from-blue-500/30 hover:to-indigo-600/30 rounded-xl border border-blue-400/30 text-left transition-all">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-white font-medium">Rapor Görüntüle</p>
                        <p className="text-sm text-slate-400">Detaylı finansal analiz</p>
                      </div>
                    </div>
                  </button>
